...
## 2. Semantic model
- [x] 2.1 (code) Timeline measures: elapsed %, remaining %, calendar and business days remaining, as-of date
- [x] 2.2 (code) Expected-today by basis (cumulative, annual, point-in-time, index) and pace status
- [x] 2.3 (code) Headline and secondary selection driven by DashboardRole
- [x] 2.4 (code) Data-state measures: Live, Stale, Pending source, Pending definition
- [x] 2.5 (code) Maturity index and heatmap measures
- [x] 2.6 (code) Active aligned projects and contributing units per goal, behind a configuration flag (Q8)
...
## 4. Verify
- [x] 4.1 Check timeline figures against a hand calculation (Aug 16, 2026 → 6.2% elapsed, 3,425 days remaining)
